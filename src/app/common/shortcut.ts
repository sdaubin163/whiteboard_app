...
// Tldraw专用快捷键
const DEFINE_TLDRAW_SHOW :string = 'Alt+Shift+Escape';
// 在有些页面(如Tldraw)中，如果页面已经定义了Escape快捷键，此处定义的快捷键会失效，因此修改为通过全局快捷键控制app的显示和隐藏
...
// 注册快捷键
    ...
    // 注册Tldraw专用快捷键
    globalShortcut.register(DEFINE_TLDRAW_SHOW, ()=>win.showTldraw());
